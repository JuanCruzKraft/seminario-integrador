        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <button
                onClick={() => router.back()}
                className="mr-2 p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100"
              >
              ...
              <button
                onClick={() => router.push('/')}
                className="mr-4 flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors"
              >
                ...
                {pedidos.map((pedido) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Botón de calificar siempre visible para pedidos entregados */}
                          ...
                          <button
                            onClick={(e) => {
                              ...
                              if (pedido.calificado) {
                                // Opcional: mostrar mensaje de que ya fue calificado
                                alert('Este pedido ya ha sido calificado')
                              } else {
                                router.push(`/calificar/${pedido.pedidoID}`)
                              }
                            }}
                            className={`w-full flex items-center justify-center px-4 py-2 font-medium rounded-lg transition-colors ${
                              pedido.calificado
                                ? 'bg-gray-300 text-gray-600 cursor-not-allowed'
                                : 'bg-indigo-600 hover:bg-indigo-700 text-white'
                            }`}
                            disabled={pedido.calificado}
                          >
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                            </svg>
                            {pedido.calificado ? 'Ya Calificado' : 'Calificar Pedido'}
                          </button>
                        </div>
                      )}
